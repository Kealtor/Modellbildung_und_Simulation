function [phi_uds,phi_cds,x,el,xel,peclet,dcfl,zeit] = MuS_FDM_1(dt,nx,rho,u0,gamma)
%
...
% e_uds = (el(1:10:101) - phi_uds) ./el(1:10:101);
% e_cds = (el(1:10:101) - phi_cds) ./el(1:10:101);
